...
<!-- container-->
    <div class="container">
                    ...
                    <div class="panel-body">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">FILE BOARD</h4><br>
                                This is FileBoard!
                            </div>
                        </div><!-- end media -->
                    </div>
        ...
        <div class="row">
        	<!-- 새글 등록 버튼 -->
        	<div class="col-md-4">
        		<button id='regBtn' type="button" class="btn">Register New File Board</button>
        	</div>
        	<!-- 검색 처리 -->
        	<div class="col-md-8 input-group">
        		<form id='searchForm' class="pull-right" method="get" action="/fileBoard/fileBoardList">
	...
	<form id='actionForm' action="/fileBoard/fileBoardList" method='get'>
...
$(document).ready(function() {
	...
	$("#regBtn").on("click", function() {
		self.location = "/fileBoard/fileBoardRegister";
	});
	...
	$(".move").on("click",function(e) {
		...
		actionForm.attr("action","/fileBoard/fileBoardRead");
		actionForm.submit();
	});
